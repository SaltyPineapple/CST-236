...
class orderBusinessService{
    ...
    function doOrder($coupon){
        ...
        $orderDetails = $this->createOrderDetails($this->con, $cart, $orderNumber, $coupon);
    ...
    function createOrderDetails($con, $cart, $orderNum, $coupon){
        ...
        foreach($cart->getItems() as $value=>$qty){
            ...
            $sql = "INSERT INTO ORDER_DETAILS (QUANTITY, ORDER_ID, PRODUCT_ID, ORDER_PRICE) values ($qty, $orderNum, $value, $qty*$price * (1-($coupon/100)))";
